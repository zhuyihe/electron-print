<template>
    <div>
        <el-dialog width="300px" :visible.sync="dialogVisible" :append-to-body="true" :show-close="false" title="打印机设置">
...
export default {
    ...
    computed: {
        defaultPrint() {
            return this.$electronStore.get('RR') || ''
        }
    },
    watch: {
        dialogVisible: {
